...
set_target_properties(LTO PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib64/libLTO.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/LTO.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LTO )
list(APPEND _IMPORT_CHECK_FILES_FOR_LTO "${_IMPORT_PREFIX}/lib64/libLTO.dll.a" "${_IMPORT_PREFIX}/bin/LTO.dll" )
...
set_target_properties(LLVMgold PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/LLVMgold.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMgold )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMgold "${_IMPORT_PREFIX}/lib64/LLVMgold.dll" )
...
set_target_properties(SampleAnalyzerPlugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/SampleAnalyzerPlugin.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS SampleAnalyzerPlugin )
list(APPEND _IMPORT_CHECK_FILES_FOR_SampleAnalyzerPlugin "${_IMPORT_PREFIX}/lib64/SampleAnalyzerPlugin.dll" )
...
set_target_properties(CheckerDependencyHandlingAnalyzerPlugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/CheckerDependencyHandlingAnalyzerPlugin.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS CheckerDependencyHandlingAnalyzerPlugin )
list(APPEND _IMPORT_CHECK_FILES_FOR_CheckerDependencyHandlingAnalyzerPlugin "${_IMPORT_PREFIX}/lib64/CheckerDependencyHandlingAnalyzerPlugin.dll" )
...
set_target_properties(CheckerOptionHandlingAnalyzerPlugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/CheckerOptionHandlingAnalyzerPlugin.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS CheckerOptionHandlingAnalyzerPlugin )
list(APPEND _IMPORT_CHECK_FILES_FOR_CheckerOptionHandlingAnalyzerPlugin "${_IMPORT_PREFIX}/lib64/CheckerOptionHandlingAnalyzerPlugin.dll" )
...
set_target_properties(LLVM PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib64/libLLVM.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/LLVM.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVM )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVM "${_IMPORT_PREFIX}/lib64/libLLVM.dll.a" "${_IMPORT_PREFIX}/bin/LLVM.dll" )
...
set_target_properties(Remarks PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib64/libRemarks.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/Remarks.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS Remarks )
list(APPEND _IMPORT_CHECK_FILES_FOR_Remarks "${_IMPORT_PREFIX}/lib64/libRemarks.dll.a" "${_IMPORT_PREFIX}/bin/Remarks.dll" )
